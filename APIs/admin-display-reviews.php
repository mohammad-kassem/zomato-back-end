...
$query = $mysqli->prepare("SELECT restaurants.restaurant_name, users.first_name, users.last_name, reviews.rating, reviews.content, reviews.date_posted, reviews.status, reviews.review_id
FROM reviews 
