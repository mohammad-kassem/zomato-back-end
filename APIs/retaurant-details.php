...
$query=$mysqli->prepare("Select r.restaurant_name, r.description as restaurant_description, r.image, c.category_name, r.location, r.average_cost, avg(re.rating) as restaurant_rating from restaurants r, categories c, reviews re where r.restaurant_id = ? and r.category_id = c.category_id and r.restaurant_id = re.restaurant_id group by re.restaurant_id");
